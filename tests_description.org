...
*Return value*: NULL.
** DONE ft_itoa [6/6]
CLOSED: [2023-11-27 Mon 15:08]
#+begin_src C
char    *ft_itoa(int n);
#+end_src
*** CODED Basic inputs
CLOSED: [2023-11-27 Mon 14:59]
n set to a positive number.
*Return value*: string representing the integer.
*** CODED Negative n
CLOSED: [2023-11-27 Mon 15:01]
n set to a negative number.
*Return value*: string representing the integer.
*** CODED Maximum int
CLOSED: [2023-11-27 Mon 15:04]
...
*Return value*: string representing the integer.
*** CODED n zero
CLOSED: [2023-11-27 Mon 15:05]
n set to zero.
*Return value*: string representing the integer.
*** CODED malloc fail
CLOSED: [2023-11-27 Mon 15:06]
Make malloc fail.
*Return value*: NULL.
** TODO ft_strmapi
** TODO ft_striteri
