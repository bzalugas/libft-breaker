...
*** CODED Basic inputs
CLOSED: [2023-11-28 Tue 10:22]
s set to a normal string, f a rot13 function.
*Behavior*: s modified by f.
*Return value*: the new string.
*** CODED empty s
CLOSED: [2023-11-28 Tue 10:29]
s set to an empty string.
*Behavior*: s modified by f (nothing).
*Return value*: the new string (empty).
*** CODED NULL s
CLOSED: [2023-11-28 Tue 10:40]
s set to NULL.
*Behavior*: Nothing.
*Return value*: NULL.
*** CODED NULL f
CLOSED: [2023-11-28 Tue 10:43]
f set to NULL.
*Behavior*: Nothing.
*Return value*: NULL.
*** CODED malloc fail
CLOSED: [2023-11-28 Tue 10:44]
Make malloc fail
*Behavior*: Nothing.
*Return value*: NULL.
** TODO ft_striteri
