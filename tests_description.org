...
*Return value*: Zero.
** DONE ft_lstlast
CLOSED: [2023-12-09 Sat 20:32]
#+begin_src C
t_list  *ft_lstlast(t_list *lst);
#+end_src
*** CODED Basic input
CLOSED: [2023-12-09 Sat 20:21]
lst set to a list of multiple nodes.
*Return value*: The last node of the list.
*** CODED NULL lst
CLOSED: [2023-12-09 Sat 20:24]
lst set to NULL.
*Return value*: NULL.
** DONE ft_lastadd_back
CLOSED: [2023-12-09 Sat 21:28]
#+begin_src C
void    ft_lstadd_back(t_list **lst, t_list *new);
#+end_src
*** CODED Basic input
CLOSED: [2023-12-09 Sat 21:06]
Creation of 2 nodes then call of the function.
*Behavior*: The next element of lst is set to new.
*** CODED NULL lst
CLOSED: [2023-12-09 Sat 21:14]
lst set to NULL.
*Behavior*: lst set to new.
*** CODED NULL pointer lst
CLOSED: [2023-12-09 Sat 21:14]
lst points to NULL.
*Behavior*: lst set to new.
*** CODED NULL new
CLOSED: [2023-12-09 Sat 21:15]
new set to NULL.
*Behavior*: Nothing.
*** CODED NULL lst & new
CLOSED: [2023-12-09 Sat 21:17]
lst & new set to NULL.
*Behavior*: Nothing.
** DONE ft_lstdelone
CLOSED: [2023-12-10 Sun 20:08]
#+begin_src C
void    ft_lstdelone(t_list *lst, void (*del)(void *));
#+end_src
*** CODED Basic inputs
CLOSED: [2023-12-10 Sun 19:59]
...
*** CODED NULL lst
CLOSED: [2023-12-10 Sun 20:01]
lst set to NULL.
*Behavior*: Nothing.
*** CODED NULL del
CLOSED: [2023-12-10 Sun 20:02]
del set to NULL.
*Behavior*: Nothing.
** DONE ft_lstclear
CLOSED: [2023-12-10 Sun 21:44]
#+begin_src C
...
*Behavior*: Nothing.
** DONE ft_lstiter
CLOSED: [2023-12-10 Sun 23:29]
#+begin_src C
void    ft_lstiter(t_list *lst, void (*f)(void *));
#+end_src
*** CODED Basic inputs
CLOSED: [2023-12-10 Sun 23:14]
...
*** DONE NULL lst
CLOSED: [2023-12-10 Sun 23:20]
lst set to NULL.
*Behavior*: Nothing.
*** CODED NULL f
CLOSED: [2023-12-10 Sun 23:24]
f set to NULL.
*Behavior*: Nothing.
** DONE ft_lstmap
CLOSED: [2023-12-11 Mon 01:16]
#+begin_src C
t_list   *ft_lstmap(t_list *lst, void *(*f)(void *), void (*del)(void *));
#+end_src
*** CODED Basic inputs
CLOSED: [2023-12-11 Mon 00:31]
...
*** CODED malloc fail
CLOSED: [2023-12-11 Mon 00:36]
Same parameters but make malloc fail.
*Behavior*: Nothing.
*Return value*: NULL.
*** CODED third malloc fail
CLOSED: [2023-12-11 Mon 00:36]
...
*Return value*: NULL.
*** CODED NULL lst
CLOSED: [2023-12-11 Mon 00:37]
lst set to NULL.
*Behavior*: Nothing.
*Return value*: NULL.
*** CODED NULL f
CLOSED: [2023-12-11 Mon 00:39]
f set to NULL.
*Behavior*: Nothing.
*Return value*: NULL.
*** CODED NULL del
CLOSED: [2023-12-11 Mon 00:40]
del set to NULL.
*Behavior*: Nothing.
*Return value*: NULL.
