...
*Return value*: NULL.
** DONE ft_split
CLOSED: [2023-11-26 dim. 22:58]
#+begin_src C
char    **ft_split(char const *s, char c);
#+end_src
*** CODED Basic inputs
CLOSED: [2023-11-26 dim. 22:28]
s set to a string containing multiple times c.
*Behavior*: s is split.
*Return value*: array of new strings.
*** CODED c before & after string
CLOSED: [2023-11-26 dim. 22:31]
...
*** CODED no c in string
CLOSED: [2023-11-26 dim. 22:34]
s set to a string not containing c.
*Behavior*: s is split (only one string).
*Return value*: array of new string.
*** CODED zero c
CLOSED: [2023-11-26 dim. 22:37]
c set to zero ('\0').
*Behavior*: s is split (only one string).
*Return value*: array of new string.
*** CODED empty s
CLOSED: [2023-11-26 dim. 22:44]
s set to an empty string.
*Behavior*: s is split (only one string).
*Return value*: array of new string.
*** CODED malloc fail
CLOSED: [2023-11-26 dim. 22:50]
Make malloc fail.
*Behavior*: Nothing.
*Return value*: NULL.
*** CODED NULL s
CLOSED: [2023-11-26 dim. 22:54]
s set to NULL.
*Behavior*: Nothing.
*Return value*: NULL.
** TODO ft_itoa
